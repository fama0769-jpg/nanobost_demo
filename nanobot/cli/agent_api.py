"""Reusable API wrapper for `nanobot agent` runtime."""
...
class AgentRuntimeAPI:
    ...
    @classmethod
    def from_config(cls, config: Config, provider: BaseProvider) -> "AgentRuntimeAPI":
        """Build an API instance with the same defaults as `nanobot agent`."""
        bus = MessageBus()
