...
```bash
npx --yes clawhub@latest install <slug> --workdir ~/.cetclaw/workspace
```
...
```bash
npx --yes clawhub@latest update --all --workdir ~/.cetclaw/workspace
```

## List installed

```bash
npx --yes clawhub@latest list --workdir ~/.cetclaw/workspace
```
