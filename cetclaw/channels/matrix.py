...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install cetclaw-ai[matrix]"
    ) from e
...
from cetclaw.config.paths import get_data_dir, get_media_dir
from cetclaw.config.schema import Base
from cetclaw.utils.helpers import safe_filename
