...
from cetclaw.config.paths import get_media_dir
from cetclaw.config.schema import Base
from cetclaw.security.network import validate_url_target
from cetclaw.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm cetclaw.\n\n"
